...
TARGET="$REPO_ROOT/agents/${NAME}.md"
...
# model: Advisory for human readers; not consumed by spawn-agent.ts.
...
echo "  3. Verify with: ls -la ~/.config/opencode/agents/${NAME}.md"
echo ""
info "Definition of done checklist (from rules/definition-of-done.md):"

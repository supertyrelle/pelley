...
#   The model uses this to decide whether to auto-invoke the skill.
...
#     With agents: Read, Grep, Glob, Bash(bd:*), Bash(git:*), spawn-agent
...
echo "  4. Verify with: ls -la ~/.config/opencode/skills/${NAME}"
echo ""

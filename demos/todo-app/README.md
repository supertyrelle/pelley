...
Try running these chains in a pelley session. The primitives will parse the source code, apply the analysis, and emit structured findings in pipe format that you can review and act on.

For more primitive combinations, see `docs/primitives-cookbook.md`.

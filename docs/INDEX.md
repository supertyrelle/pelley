...
| project-bootstrapper | Full project setup with Beads | Global |
| code-reviewer | Read-only code review | Global |

Additional project-local agents can be added to `agents/`.

## Further Reading

- [Platform Guide](platform-guide.md) — feature matrix, config paths, and gotchas across Claude Code, OpenCode, and Kimi Code
...
- [Workflow Guide](opencode-guide.md) — daily usage and workflow patterns

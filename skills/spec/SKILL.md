...
allowed-tools: Read, Grep, Glob, Write, Edit, Bash(bd:*), Bash(git:*)
context: fork
---
...
**Status:** DRAFT
**Created:** [YYYY-MM-DD]
**Author:** AI-assisted (user-initiated)
...
Dispatch 3 subagents to populate the spec, each in an isolated context. Each agent gets a fresh context and specific sections to fill. All agents MUST read the actual codebase to ground their answers.

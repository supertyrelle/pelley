...
Before auditing slices, identify the project's actual architectural layers. Read the project structure, opencode.md, and top-level directories to determine the pattern in use. Common patterns:
